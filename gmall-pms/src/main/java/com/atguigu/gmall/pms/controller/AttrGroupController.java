...
public class AttrGroupController {
    ...
    public ResponseVo<List<AttrGroupEntity>> queryGroupWithAttrsByCid(
            @PathVariable("catId")Long cid){
    ...
    public ResponseVo<List<AttrGroupEntity>>queryGroupById(@PathVariable("cid")Long cid){
